...
contract Burn_Integration_Concrete_Test is Integration_Test {
    function test_RevertWhen_CallerNotBob() external {
        ...
        defaultShareToken.burn(vaultIds.defaultVault, users.depositor, DEPOSIT_AMOUNT);
    }
    ...
    function test_RevertWhen_ProvidedVaultIDDoesNotMatch() external whenCallerBob {
        ...
        defaultShareToken.burn(vaultIds.settledVault, users.depositor, DEPOSIT_AMOUNT);
    }
