...
contract ProcessTokenRedemption_Integration_Concrete_Test is Integration_Test {
    ...
    function test_RevertWhen_CallerNotBob() external {
        ...
        adapter.processTokenRedemption(vaultIds.vaultWithAdapter, users.newDepositor, DEPOSIT_AMOUNT);
    }
    ...
    function test_GivenTotalWstETHZero() external whenCallerBob {
        ...
        (uint128 transferAmount, uint128 feeAmountDeductedFromYield) =
            adapter.processTokenRedemption(vaultIds.defaultVault, users.newDepositor, DEPOSIT_AMOUNT);
        ...
        givenTotalWETHNotZero
    {
        ...
        (uint128 transferAmount, uint128 feeAmountDeductedFromYield) =
            adapter.processTokenRedemption(vaultIds.vaultWithAdapter, users.depositor, DEPOSIT_AMOUNT);
