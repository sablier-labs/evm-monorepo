...
- Bump package version for NPM release ([bd886f1](https://github.com/sablier-labs/evm-monorepo/commit/bd886f1912d11aa9362a8c2024ed317e9f8dffd5))
...
- **Breaking:** Rename `aggregateBalance` to `aggregateAmount` ([#418](https://github.com/sablier-labs/flow/pull/418))
...
- Add a function to calculate minimum fee in wei ([#454](https://github.com/sablier-labs/flow/pull/454))
...
- **Breaking:** Remove `isPaused` getter function ([#440](https://github.com/sablier-labs/flow/pull/440))
