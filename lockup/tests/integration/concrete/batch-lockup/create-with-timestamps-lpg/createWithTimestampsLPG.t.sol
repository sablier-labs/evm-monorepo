...
contract CreateWithTimestampsLPG_Integration_Concrete_Test is Integration_Test {
    function test_RevertWhen_BatchSizeZero() external {
        BatchLockup.CreateWithTimestampsLPG[] memory batchParams = new BatchLockup.CreateWithTimestampsLPG[](0);
        vm.expectRevert(Errors.SablierBatchLockup_BatchSizeZero.selector);
        batchLockup.createWithTimestampsLPG(lockup, dai, batchParams);
    }
    ...
    function test_WhenBatchSizeNotZero() external {
        ...
        expectMultipleCallsToCreateWithTimestampsLPG({
            count: defaults.BATCH_SIZE(),
            params: defaults.createWithTimestamps(),
            unlockParams: defaults.unlockParams()
        });
        ...
        uint256[] memory actualStreamIds =
            batchLockup.createWithTimestampsLPG(lockup, dai, defaults.batchCreateWithTimestampsLPG());
