...
contract StreamedAmountOf_Lockup_Linear_Integration_Fuzz_Test is Lockup_Linear_Integration_Fuzz_Test {
        ...
        givenCliffTimeNotInFuture
    {
        ...
        granularity = boundUint40(granularity, 0, defaults.END_TIME() - defaults.CLIFF_TIME());
        ...
        uint40 expectedGranularity = granularity == 0 ? 1 seconds : granularity;
        ...
        givenCliffTimeNotInFuture
    {
        ...
        // It should return a streamed amount greater than or equal to the previous streamed amount.
