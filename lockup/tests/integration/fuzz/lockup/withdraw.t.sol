...
abstract contract Withdraw_Integration_Fuzz_Test is Integration_Test {
        ...
        whenCallerRecipient
    {
        ...
        // Make the withdrawal.
        lockup.withdraw{ value: LOCKUP_MIN_FEE_WEI }({ streamId: ids.defaultStream, to: to, amount: withdrawAmount });

        // It should determine if the stream has been depleted.
        ...
        givenNotCanceledStream
    {
        ...
        uint256 previousAggregateAmount = lockup.aggregateAmount(dai);
        uint256 previousLockupETHBalance = address(lockup).balance;
        ...
        // Make the withdrawal.
        lockup.withdraw{ value: LOCKUP_MIN_FEE_WEI }(ids.defaultStream, to, withdrawAmount);
        ...
        // It should update the aggregate amount.
        assertEq(lockup.aggregateAmount(dai), previousAggregateAmount - withdrawAmount, "aggregateAmount");
        assertEq(address(lockup).balance, previousLockupETHBalance + LOCKUP_MIN_FEE_WEI, "lockup balance");
    }
}
