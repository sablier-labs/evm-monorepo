...
abstract contract LockupNFTDescriptorAddresses {
    ...
    function nftDescriptorAddress() public view returns (address addr) {
        ...
        if (chainId == ChainId.DENERGY) return 0x4749dB4834be9b473D586Ad4d98133dAfC678313;
        ...
        if (chainId == ChainId.ROBINHOOD) return 0x37BA02a35861F7254fAE733E3a7cADD96D9D32A2;
