...
contract HasRoleOrIsAdmin_Integration_Concrete_Test is Base_Test {
    ...
    function test_WhenAccountHasRole() external view whenAccountNotAdmin {
        // It should return true.
        bool actualHasRole = roleAdminableMock.hasRoleOrIsAdmin(FEE_COLLECTOR_ROLE, users.accountant);
        assertTrue(actualHasRole, "hasRoleOrIsAdmin");
    }

    function test_WhenAccountNotHaveRole() external view whenAccountNotAdmin {
        // It should return false.
        bool actualHasRole = roleAdminableMock.hasRoleOrIsAdmin(FEE_COLLECTOR_ROLE, users.eve);
