...
- **Breaking**: Rename `RoleGranted` event to `GrantRole`
  ([#1433](https://github.com/sablier-labs/evm-monorepo/pull/1433))
- **Breaking**: Merge `DisableCustomFeeUSD` and `SetCustomFeeUSD` events into `UpdateCustomFeeUSD`
  ([#1369](https://github.com/sablier-labs/evm-monorepo/pull/1369))

### Added

- **Breaking**: Add Bob protocol fee support to initialize function of Comptroller
  ([#1421](https://github.com/sablier-labs/evm-monorepo/pull/1421))
  - Add `Bob` to `ISablierComptroller.Protocol` enum ([#1404](https://github.com/sablier-labs/evm-monorepo/pull/1404))
- Add `SafeOracle` library ([#1413](https://github.com/sablier-labs/evm-monorepo/pull/1413))
...
- Add `lowerMinFeeUSDForCampaign` function to Comptroller
  ([#1371](https://github.com/sablier-labs/evm-monorepo/pull/1371))
- Add `withdrawERC20Token` function to withdraw ERC20 Tokens from Comptroller
  ([#1404](https://github.com/sablier-labs/evm-monorepo/pull/1404))
- Add versioning to Comptroller ([#1402](https://github.com/sablier-labs/evm-monorepo/pull/1402))
- Add `DEFAULT_SABLIER_MULTISIG_ADMIN` address to `BaseScript`
  ([#1397](https://github.com/sablier-labs/evm-monorepo/pull/1397))

### Removed

- Drop support for Blast, CoreDAO and SEI chains from `ChainId` library
  ([#1391](https://github.com/sablier-labs/evm-monorepo/pull/1391),
  [#1451](https://github.com/sablier-labs/evm-monorepo/pull/1451))
...
[2.0.0]: https://github.com/sablier-labs/evm-monorepo/releases/tag/utils@v2.0.0
[2.0.1]: https://github.com/sablier-labs/evm-monorepo/releases/tag/utils@v2.0.1
